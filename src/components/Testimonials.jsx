const testimonials = [
  {
    quote: "INCC provided the legal support I needed to fight for my community's land rights. Their professionalism and dedication are exemplary.",
  ...
  {
    quote: "Volunteering with INCC opened my eyes to real systemic challenges. They are making a measurable impact in communities every day.",
    name: "Priya Sharma",
...
function Testimonials() {
  return (
    <section className="bg-[#f3f3f5] py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white p-8 border border-[#e2e2e4] relative">
