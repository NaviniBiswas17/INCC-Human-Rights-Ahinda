    ...
    <section id="about" className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Vision Card */}
          <div className="bg-[#f5f5f7] border-l-4 border-[#b51a1b] p-8">
          ...
          {/* Mission Card */}
          <div className="bg-[#f5f5f7] border-l-4 border-[#e9c349] p-8">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-14 h-14 bg-[#00113a] flex items-center justify-center shrink-0">
        ...
        <div className="mt-16 pt-12 border-t border-[#e2e2e4]">
          <div className="flex flex-wrap items-center justify-center gap-4 lg:gap-8">
            {[
              { icon: "verified_user", text: "Section 8 Certified" },
              { icon: "policy", text: "Government Authorized" },
              { icon: "gavel", text: "Legal Aid Provider" },
              { icon: "workspace_premium", text: "12+ Years Service" }
            ].map((badge, idx) => (
              <div key={idx} className="flex items-center gap-3 px-6 py-3 bg-[#f5f5f7] border border-[#e2e2e4]">
                <span className="material-symbols-outlined text-[#b51a1b]">{badge.icon}</span>
                <span className="text-sm font-bold text-[#00113a] uppercase tracking-wide">{badge.text}</span>
              </div>
            ))}
          </div>
        </div>
